...
public class GetProfileReccurring extends Transaction {

    public GetProfileReccurring () {
    }

    public static void main(String args[]) {
        System.out.println("------------------------------------------------------");
        System.out.println("Executing Sample from File: GetProfileReccurring.java");
        System.out.println("------------------------------------------------------");
        ...
        recurInfo.setOrigProfileId("RT0000000001");   // Example: RP0000000012
